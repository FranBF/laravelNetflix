                                ...
                                @auth
                                    Inicio <p>
                                        <a href="{{ route('users.edit', Auth::user()->id) }}"
                                            class="btn btn-primary my-2">Perfil</a>
                                        <a href="{{ route('videos.create', Auth::user()->id) }}"
                                            class="btn btn-secondary my-2">Subir Video</a>
                                    </p>
                                @else
                                    Inicia sesion <a href="{{ route('home') }}" class="btn btn-dark">Iniciar Sesión</a>
                                @endauth
                            </h1>
